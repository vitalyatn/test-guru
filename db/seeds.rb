...
PassedTest.create(user_id: 2, test_id: 1 , score: 8)
PassedTest.create(user_id: 1, test_id: 2 , score: 6)
PassedTest.create(user_id: 3, test_id: 1 , score: 10)
PassedTest.create(user_id: 3, test_id: 2 , score: 8)
PassedTest.create(user_id: 3, test_id: 3 , score: 6)
PassedTest.create(user_id: 3, test_id: 4 , score: 6)
